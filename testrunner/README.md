...
| [google_service_account.testrunner_dashboard_workload_sa](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/service_account) | resource |
...
| <a name="input_dashboard_namespace"></a> [dashboard\_namespace](#input\_dashboard\_namespace) | The Kubernetes namespace of the TestRunner Dashboard | `string` | `"default"` | no |
