...
module "workspace_manager" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//terra-workspace-manager?ref=terra-workspace-manager-0.4.5"
...
module "buffer" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//buffer?ref=buffer-0.1.1"
