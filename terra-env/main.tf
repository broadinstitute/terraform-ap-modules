...
module "workspace_manager" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//terra-workspace-manager?ref=TOAZ-199-add-deployment-support-for-lz-databases"
...
module "buffer" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//buffer?ref=buffer-0.3.3"
