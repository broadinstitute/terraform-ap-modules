...
module "rbs" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//rbs?ref=rbs-0.0.6"
...
module "leonardo" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//rawls?ref=ch-leo-ingress"
