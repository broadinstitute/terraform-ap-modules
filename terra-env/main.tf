...
module "workspace_manager" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//terra-workspace-manager?ref=tn-PF-324-WSM-access-RBS-folders"
...
module "buffer" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//buffer?ref=tn-PF-323-add-folder-creation-bool"
