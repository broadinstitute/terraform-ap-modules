...
module "crl_janitor" {
  source = "github.com/broadinstitute/terraform-ap-modules.git//crl-janitor?ref=yyu-PF-161"
...
module "buffer" {
  ...
  source = "github.com/broadinstitute/terraform-ap-modules.git//buffer?ref=byyu-PF-161"
