...
output "sqlproxy_sa_id" {
  ...
  description = "Terra Data Catalog Cloud SQL Proxy Google service account ID"
}
output "app_sa_id" {
  value       = length(google_service_account.app) > 0 ? google_service_account.app[0].account_id : null
  description = "Terra Data Catalog App Google service account ID"
}
